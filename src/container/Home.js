...
function Index() {
    ...
    let description1="Spacecode is a programming website for researcher who wants to create a collaborative place to share "
    ...
    return (
        <React.Fragment>
            <div style={{ backgroundColor: "transparent", height: "300px", marginTop: "100px",marginLeft:"30px"}}>
                <Texty style={{ fontFamily: "Impact", fontSize: "88px", marginLeft: "22px" }}>Welcome to SpaceCode !</Texty>
